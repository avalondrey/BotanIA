...
export const TREE_CARDS: Record<string, PlantCard> = {
  ...
  thuya: {
    ...
    treeLifespan: 100,
    firstHarvestYears: 15,
    annualYield: 'Variable',
    treeData: {
      pollinationType: 'Autofertile',
      pollinator: null,
      frostResistance: -25,
      soilType: 'Tous types, préfère frais et bien drainé',
      soilPH: '6.0-7.5',
      pruningNotes: 'Thuja occidentalis Smaragd - Conifère persistant, port columnaire étroit, idéal haie. Rustique jusqu',
      fruitEdible: true,
    },
  },
