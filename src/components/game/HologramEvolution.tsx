...
import { PLANT_FAMILY_MAP, getPlantFamily } from '@/lib/botany-constants';
...
'fig': {
  ...
  escallonia: {
    ...
    stageDurations: [21, 40, 60, 90],
    companions: [
      { plantId: 'photinia', type: 'beneficial', reason: 'Complément haie persistante' },
      { plantId: 'laurus', type: 'beneficial', reason: 'Association aromatique' },
    ],
    diseaseRisks: [
      { name: 'Tavelure', emoji: '🍂', triggerConditions: 'HR>85%, T15-25°C', prevention: 'Tailler, aérer' },
    ],
    optimalPlantMonths: [3, 4, 5, 9, 10],
    harvestSeason: ['autumn', 'winter'],
    totalDaysToHarvest: 200,
  ...
  thuya: {
    ...
    companions: [
      { plantId: 'eleagnus', type: 'beneficial', reason: 'Complément visuel' },
    ],
    diseaseRisks: [
      { name: 'Phytophthora', emoji: '🌧️', triggerConditions: 'Sol trop humide', prevention: 'Drainage, éviter engorgement' },
    ],
    optimalPlantMonths: [3, 4, 5, 9, 10],
    harvestSeason: ['year-round'],
    totalDaysToHarvest: 300,
  ...
  corn: {
    ...
    optimalSoilTemp: 22,
    lightNeedHours: 8,
    stageDurations: [12, 18, 18, 22],
    companions: [
      { plantId: 'bean', type: 'beneficial', reason: 'Fixation azote, ombre légère' },
      { plantId: 'squash', type: 'beneficial', reason: 'Mulch naturel, rétention eau' },
    ],
    diseaseRisks: [
      { name: 'Charbon', emoji: '🍂', triggerConditions: 'Humidité élevée', prevention: 'Semences saines, rotation' },
    ],
  ...
  sorrel: {
    ...
    companions: [
      { plantId: 'strawberry', type: 'beneficial', reason: 'Economie d\'espace' },
    ],
    diseaseRisks: [
      { name: 'Rouille', emoji: '🍂', triggerConditions: 'Humidité', prevention: 'Espacement, ventilation' },
    ],
  ...
  quince: {
    ...
    companions: [
      { plantId: 'garlic', type: 'beneficial', reason: 'Repousse ravageurs' },
    ],
    diseaseRisks: [
      { name: 'Tavelure', emoji: '🍂', triggerConditions: 'HR>80%, T15-25°C', prevention: 'Taille, traitements préventifs' },
    ],
    optimalPlantMonths: [10, 11, 2, 3],
    harvestSeason: ['autumn'],
  ...
  currant: {
    ...
    companions: [
      ...
      { plantId: 'tomato', type: 'harmful', reason: 'Espacement' },
    ],
    diseaseRisks: [
      { name: 'Oïdium', emoji: '🌞', triggerConditions: 'HR>70%, T15-25°C', prevention: 'Taille, circulation air' },
    ],
    optimalPlantMonths: [10, 11, 2, 3],
    harvestSeason: ['summer'],
    totalDaysToHarvest: 730,
    plantFamily: 'Grossulariaceae',
