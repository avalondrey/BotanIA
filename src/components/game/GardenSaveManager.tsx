  ...
  const handleSave = async (slotId: string) => {
    try {
      ...
      const gameState = {
        ...
        unlockedVarieties: store.unlockedVarieties,
        discoveredPlants: store.discoveredPlants,
        day: store.day,
        season: store.season,
