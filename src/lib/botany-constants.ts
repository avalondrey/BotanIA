...
export const PLANT_VARIETY_MAP: Record<string, string> = {
  ...
  'apple-golden': 'apple',
  'apple-belle': 'apple',
  'apple-belle-fleur': 'apple',
  'apple-reine': 'apple',
  'apple-reine-reinettes': 'apple',
  'apricot-bergeron': 'apricot',
  'arbousier-rubra': 'arbousier',
  'cherry-bing': 'cherry',
  'pear-conference': 'pear',
  'pear-louise': 'pear',
  'pear-louise-bonne': 'pear',
  'pear-williams': 'pear',
  ...
  'tomato-saint': 'tomato',
  'tomato-saint-pierre': 'tomato',
  'pepper-ariane': 'pepper',
  'pepper-california': 'pepper',
  'pepper-california-wonder': 'pepper',
  'pepper-chocolat': 'pepper',
  'pepper-doux': 'pepper',
  'pepper-doux-espagne': 'pepper',
  'pepper-doux-france': 'pepper',
  'eggplant-long': 'eggplant',
  'eggplant-long-violette': 'eggplant',
  'eggplant-longue': 'eggplant',
  'eggplant-longue-violette': 'eggplant',
  ...
  'cucumber-le-genereux': 'cucumber',
  'cucumber-marketer': 'cucumber',
  'cucumber-marketer-vilmorin': 'cucumber',
  'cucumber-rollisons': 'cucumber',
  'cucumber-rollisons-telegraph': 'cucumber',
  'basil-genoveois': 'basil',
  'basil-loki': 'basil',
  'basil-marseillais': 'basil',
  'bean-coco': 'bean',
  'bean-coco-paimpol': 'bean',
  'bean-coco-rouge': 'bean',
  'squash-butternut': 'squash',
  'squash-butternut-coco': 'squash',
  'squash-butternut-musquee': 'squash',
  'squash-striped': 'squash',
  'squash-striped-cushaw': 'squash',
  'corn-miel': 'corn',
  'corn-miel-jaune': 'corn',
  'corn-pop': 'corn',
  'corn-pop-rouge': 'corn',
  'sunflower-titania': 'sunflower',
  'sunflower-velours': 'sunflower',
  'maple-acer': 'maple',
  'maple-acer-platanoides': 'maple',
  'magnolia-grandiflora': 'magnolia',
  'pine-sylvestris': 'pine',
  'oak-pedoncule': 'oak',
  'birch-betula': 'birch',
  'chard-vert-lyon': 'chard',
  'amaranth-red-garnet': 'amaranth',
  'quinoa-tempe': 'quinoa',
  'sorrel-oseille-commune': 'sorrel',
  'parsley-lion': 'parsley',
  'photinia-louise': 'photinia',
  'spinach-soyuz': 'spinach',
  'radis-expo': 'radish',
  'melon-stellio': 'melon',
  'walnut-franquette': 'walnut',
  'fig-goutte-or': 'fig',
  'peach-sanguine': 'peach',
  'plum-reine-claude': 'plum',
  'quince-champion': 'quince',
  'baco-noir': 'grape',
};
