...
export const CARD_DATA = {
  ...
  // === IMAGE ASSETS ===
  packetImage: "/packets/vilmorin/packet-parsley-lion.png",
  cardImage: "/cards/seeds/vilmorin/parsley-lion.png",
  stages: [
  ...
  // === NOTES DE CULTURE ===
  notes: "Nouveauté 2026 — Persil frisé, saveurs intenses et culture aisée. Idéal pour taboulé et garniture.",
