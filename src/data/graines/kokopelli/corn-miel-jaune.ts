...
export const CARD_DATA = {
  ...
  // === IMAGE ASSETS ===
  packetImage: "/packets/kokopelli/packet-corn-miel-jaune.png",
  cardImage: "/cards/seeds/kokopelli/corn-miel-jaune.png",
  stages: [
    "/plants/corn-stage-1.png",
    "/plants/corn-stage-2.png",
    "/plants/corn-stage-3.png",
    "/plants/corn-stage-4.png",
    "/plants/corn-stage-5.png",
    "/plants/corn-stage-6.png",
  ],
  ...
  // === NOTES DE CULTURE ===
  notes: "Maïs doux jaune ancien, épis de 20cm, grains sucrés. Semis avril-mai, récolte 110j. Pollinisation croisée.",
