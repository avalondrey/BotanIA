/**
 * Poirier Colonnaire Londres® — Pépinière locale
 * Pyrus communis
 */

export const CARD_DATA = {
  id: "poirier-colonnaire-londres",
  plantDefId: "pear-colonnaire-londres",
  shopId: "pepiniere-locale",
  category: "fruit-tree" as const,
  name: "Poirier Colonnaire Londres®",
  emoji: "🍐",
  packetImage: "/packets/pepiniere-locale/packet-poirier-colonnaire-londres.png",
  cardImage: "/cards/seeds/pepiniere-locale/poirier-colonnaire-londres.png",
  stages: [
    "/plants/pear-colonnaire-londres-stage-1.png",
    "/plants/pear-colonnaire-londres-stage-2.png",
    "/plants/pear-colonnaire-londres-stage-3.png",
    "/plants/pear-colonnaire-londres-stage-4.png",
    "/plants/pear-colonnaire-londres-stage-5.png",
  ],
  price: 1945,
  gramsPerPacket: 0,
  period: {
  ...
  yield: {
    ...
    conservation: "2-4 mois en cave fraîche",
  },
  taste: "Chair fondante et sucrée",
  consumption: "Frais, compote, jus, tarte",
  nutrition: { calories: "57 kcal/100g", vitaminC: "Présente", fibers: "Modérée" },
  notes: "Poirier colonnaire Londres® - Port très étroit, idéal balcon et petit jardin. Partiellement autofertile.",
