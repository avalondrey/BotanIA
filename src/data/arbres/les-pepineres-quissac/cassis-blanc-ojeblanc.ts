...
export const CARD_DATA = {
  ...
  emoji: "🍇",
  packetImage: "/plantules/plantule-cassis-blanc.png",
  cardImage: "/plantules/plantule-cassis-blanc.png",
  stages: [
    "/plants/blackcurrant-stage-1.png",
    "/plants/blackcurrant-stage-2.png",
    "/plants/blackcurrant-stage-3.png",
    "/plants/blackcurrant-stage-4.png",
    "/plants/blackcurrant-stage-5.png",
  ],
  price: 90,
  gramsPerPacket: 0,
  period: {
